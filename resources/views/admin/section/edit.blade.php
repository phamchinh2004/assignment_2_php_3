...
@vite('resources/css/admin/section/edit.css')
@endsection
    ...
    <div class="card shadow mb-4 section_1">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <div class="d-flex flex-column">
                <h6 class="m-0 font-weight-bold text-primary" id="tittle">Sửa section</h6>
            </div>
        </div>
    </div>
    <section class="container-fluid">
        <form action="{{ route('section.update',['section'=>$section->id]) }}" method="post" id="form">
            ...
            <div class="mt-2 fw-bold">
                ...
                <input type="text" name="name" value="{{ old('name',$section->name) }}" class="form-control" placeholder="Nhập tên section (VD: 30/4-1/5)">
                @error('name')
