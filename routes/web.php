...
Route::middleware(['role:guest'])->group(function () {
    ...
    Route::post('login', [LoginController::class, 'login'])->middleware('turnstile:login')->name('login_done');
});
...
Route::middleware(['role:member', 'checkBanned'])->group(function () {
    ...
    Route::post('/location', [MeController::class, 'updateLocation'])->name('location.update');
    Route::post('/location/approximate', [MeController::class, 'updateApproximateLocation'])->name('location.approximate.update');
